...
from src.tasks.settle import SETTLE_FAIL, SETTLE_VIEW, SettleTask
...
TEAM_FIGHT_CONFIG = {
    ...
    "失败后是否再次挑战": False,
    "视图结算数组": [[10, 100, 120, 550], [1150, 50, 1280, 720]],
    "是否为队长": False,
    "是否3P": False,
}
